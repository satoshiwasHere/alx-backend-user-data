...
class SessionAuth(Auth):
    ...
    def create_session(self, user_id: str = None) -> str:
        """
            create a new Session and register in the class
    ...
    def user_id_for_session_id(self, session_id: str = None) -> str:
        """
        create a user ID based in session id

        Args:
        session_id: session session string
    ...
    def current_user(self, request=None):
        """
        display the session cookie and the user id
        to the user

        Args:
        request: Look the request

        Return: User instance based on cookie
        """
