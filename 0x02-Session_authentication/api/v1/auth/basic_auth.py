...
class BasicAuth(Auth):
    ...
    def extract_base64_authorization_header(
        ...
        """
            Extract's theader in base64

            Args: authorization_header: string in base64

            Return: Header in base64 or Null
        """
    ...
    def decode_base64_authorization_header(
        ...
        """
            ...
            Args: base64_authorization_header: Base64 header

            Return: decoded string header or Null
        """
    ...
    def extract_user_credentials(self,
        ...
        """
            ...
            Args: decoded_base64_authorization_header: string

            Return: tuple about user credentials (user_email, user_pwd)
                or tuple (None, None)
        """
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        """
            Overload func to get user info

            Args: request- current user

            Return: Info of the current user or users, otherwise None
        """
